...
// float* x_set = new float[224 * 108]; ///< @brief 输出的点云x坐标序列数据起始指针
// float* y_set = new float[224 * 108]; ///< @brief 输出的点云y坐标序列数据起始指针
// float* z_set = new float[224 * 108]; ///< @brief 输出的点云z坐标序列数据起始指针
// bool covertToPointCloud(iscas::PointCloud& pnt_cloud_origin)
// {
    
//     for (int i = 0; i < 224 * 108; i++)
// 	{
...
//     pnt_cloud_origin.size = width * height;
//     pnt_cloud_origin.width = width;
//     pnt_cloud_origin.height = height;
